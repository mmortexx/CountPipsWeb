...
| `calendario-muestra.test.ts` | Muestra de /features: el calendario de julio de 2026 empieza en su día y tiene 31; ningún cierre en fin de semana salvo cripto, sin cambiar el resultado total |
