          ...
          {ORDEN_LAMINAS.map((clave, i) => {
            ...
            return (
              <button
                ...
                className="shrink-0 rounded-[2px] px-3.5 py-2 text-[14px] transition-colors min-h-[44px]"
                style={{
              ...
              >
                <span className="tnum mr-2 text-[12px] tracking-[0.14em]" style={{ color: "rgb(var(--accent-base))" }}>
                  {l.roman}
                </span>
