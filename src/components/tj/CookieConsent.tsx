      ...
      {visible && !dismissed && (
        <div
          ...
          style={{ position: "fixed" }}
            ...
            className="tj-entra-abajo tj-cristal tj-cristal--denso z-50 safe-bottom left-0 bottom-0 w-full rounded-t-[18px] p-4 md:left-4 md:bottom-4 md:w-[22rem] md:rounded-[16px] md:p-5"
          >
